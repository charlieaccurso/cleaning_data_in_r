...
# us_census <- us_census %>%
#   mutate_at(vars(Hispanic, White, Black, Native, Asian, Pacific),
...
us_census <- us_census %>% mutate(
  Hispanic=Hispanic*0.01,
  White=White*0.01,
  Black=Black*0.01,
  Native=Native*0.01,
  Asian=Asian*0.01,
  Pacific=Pacific*0.01
)
head(us_census)
